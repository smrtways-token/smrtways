...
/*
    ...
    3% of every transaction is redistributed between holders of the token
    1% goes to the liquidity pool
    1% is burned
    1% Charity
    1% of each transaction goes to the marketing wallet 
    3% go to the team members
    
    Telegram: https://t.me/joinchat/SztgCp8sGb4-8WJw
    Twitter: https://twitter.com/smrtways
    Website: https://smrtways.org/
...
contract Smrtways is Context, IERC20, Ownable {
    ...
    string private _name = "smrtways";
    string private _symbol = "SMRT";
    ...
    uint256 public _marketingTeamFee = 5; //hardcoded and unchangeable 
    uint256 private _previousMarketingTeamFee = _marketingTeamFee;
    
    uint256 public _maxTxAmount = 5000 * 10**6 * 10**9;
    uint256 private minimumTokensBeforeSwap = 100 * 10**6 * 10**9; 
    
    address payable public marketingAddress = 0x698795E53d8339F5Fc9EA2f2b18D80D6D8a64962; //Marketing
    address payable public teamAddress = 0x2748916d34A82178d8B316755D81a3c8B687db37; //Team 
    address payable public charityAddress = 0x53409c59F59D6984cd83Acb57288C9151264fcEF; //Charity

    address public dxTokenLockerAddress = 0x703C244139d9cf022Bd7aB3D9F9Ee9d7aa61Ad39;
    address public disperseAppAddress = 0xD152f549545093347A162Dce210e7293f1452150;
    // Proof: https://bscscan.com/address/0xd152f549545093347a162dce210e7293f1452150
    ...
    constructor () public {
        ...
        _isExcludedFromFee[disperseAppAddress] = true; //for airdrops to work
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 marketingBNB = (marketingTeamBalance.div(100)).mul(20);
        TransferMarketingBNB(marketingAddress, marketingBNB);
        
        uint256 teamBNB = (marketingTeamBalance.div(100)).mul(60);
        TransferTeamBNB(teamAddress, teamBNB);

	uint256 charityBNB = (marketingTeamBalance.div(100)).mul(20);
        TransferCharityBNB(charityAddress, charityBNB);
    }
    ...
    function setTeamAddress(address payable team) external onlyOwner() {
        teamAddress = team;
    }
    
    function setMarketingAddress(address payable marketing) external onlyOwner() {
    ...
    function TransferMarketingBNB(address payable recipient, uint256 amount) private {
        recipient.transfer(amount);
    }
    
    function TransferTeamBNB(address payable recipient, uint256 amount) private {
        recipient.transfer(amount);
    }
